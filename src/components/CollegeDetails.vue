                ...
                <div class="row" v-for="sem in semester" :key="sem.id">
                    <div class="card" id="main_card">
                        <h5 class="card-header">
                            <div class="collapsed d-block kj"   aria-expanded="true" data-toggle="collapse" :href="'#collapse-example' + sem.id"
                                                                    ...
                                                                    <div class="col-lg-8 col-9 col-sm-9 col-md-9">
                                                                        <div class="row">
                                                                            <div class="col-lg-12 col-9 col-sm-9 col-md-9">
                                                                                <p id="sub_text" class="mb-0"><b>Math 1 (NEP
                                                                                        Series)</b></p>
                                                                            </div>
                                                                            <div class="col-lg-12 col-9 col-sm-9 col-md-9">
                                                                                <p id="code_text"><small>18CS81&nbsp;240
                                                                                        hrs</small></p>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-lg-12 mn">
                                                                <div class="row">
                                                                    <div class="col-lg-9 col-9 col-sm-9 col-md-9">
                                                                        <p style="padding-top:10px;" id="desc_text"><b>{{
                                                                            cou.description }}</b></p>
                                                                    </div>
