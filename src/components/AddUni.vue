  ...
  <div class="container">
    ...
    <div class="container" style="margin-top: 72px;">
      <div>
        ...
        <el-select v-model="selectedUni" placeholder="Please Select" style="padding: 4px;" @change="emitSelectedType">
    <el-option
              ...
              <el-form ref="form" :model="newBranch" label-position="top" class="frm">
                  <el-form-item>{{ newBranch.id }}</el-form-item>
                      ...
                      <el-form-item label="Branches Id" prop="branchesId">
                          <el-input :value="localSelectedBranch" readonly required></el-input>
                      </el-form-item>
...
methods: {
  ...
  emitSelectedType() {
    this.$emit('selected-university-changed', this.selectedUni, this.localSelectedBranch);
    this.loadData(); 
    this.loadProductDetails();
  },
  toggleForm() {
