  ...
  <div class="purple_block">
                        ...
                        <div class="row mt-5">
                             <div class="col-sm-6">
                              ...
                              <input style="border-color: #DEDEDE;" type="text" name=" Name " placeholder="User Name"/>
                             </div>
                             <div class="col-sm-6 view">
                                <button style="color: #0177FB; border-color: #0177FB;">Save</button>
                             </div>
                        </div>
                        <div class="row mt-3">
                             <div class="col-sm-6">
                            <div class="card st" >
                                <div class="card body">
                                    ...
                                    <input class="bb" style="border-color: #DEDEDE;" type="text" name=" Name " placeholder=" userName@email.com"/>
                                   </div>
                            </div>
                            ...
                            <div class="card mt-4 st">
                                <div class="card body">
                                  ...
                                  <p class="sub_hed">Last access to application</p>
                                   ...
                                   <p class="sub_hed" style="margin-top: -7px;"> Tuesday, 5 September 2023, 09:46 PM </p>
                                    <p class="sub_hed" style="margin-top: -7px;"> Monday, 4 September 2023, 09:46 PM </p> 
                                    <p class="sub_hed" style="margin-top: -7px;">Sunday, 3 September 2023, 09:46 PM</p> 
                                    <p class="sub_hed" style="margin-top: -7px;">Saturday, 2 September 2023, 09:46 PM</p>
                                </div>
                            </div>  
                             </div>
                        </div>
