<template>
  <div class="container">
    <p>Dashbord > University Update </p>
    <div class="row">
      ...
      <div class="col-lg-6 col-sm-12">
        <form v-show="formVisible" class="frm" style="margin-top:23px" @submit.prevent="addBranch">
          ...
          <input id="academiaId" v-model="newBranch.branchesId" type="text" required><br>

          <label for="universityName"><b>University Name:</b></label>
          <input id="branchName" v-model="newBranch.universityName" type="text" required>
