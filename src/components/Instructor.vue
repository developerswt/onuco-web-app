            ...
            <section id="tab_block" v-for="facult in faculty" :key="facult.id">
                <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="CONTACT" name="second">
                        <h2 class="Object_text"><img src="../assets/images/maskGroup29.png" class="img-fluid" /> Contact</h2>
                    ...
                    <el-tab-pane label="EDUCATION" name="third">
                        <div class="education_block">
                            <h2 class="Object_text"><img src="../assets/images/maskGroup29.png" class="img-fluid" /> EDUCATION
                            </h2>
                    ...
                    <el-tab-pane label="SKILLS" name="eight">
                        <h2 class="Object_text"><img src="../assets/images/maskGroup29.png" class="img-fluid" /> Skills</h2>
                        <p style="padding-left: 25px;"><span id="Sub_text">Skill:</span>{{ facult.skill }}</p>
                    </el-tab-pane>
                    <el-tab-pane label="CONTRIBUTIONS" name="nine">
                        <h2 class="Object_text"><img src="../assets/images/maskGroup29.png" class="img-fluid" /> Contributions</h2>
