<template>
    <div class="container">
      ...
      <div class="container" style="margin-top: 72px;">
        <div>
          <label for="productDropdown">Select Course Name:</label>
  ...
  export default {
    ...
    //   if (Array.isArray(this.products.courses)) {
    //     this.rowData = this.products.courses;
    //   } else {
    //     console.error('courses is not an array:', this.products.courses);
    //     this.rowData = []; 
    //   }
  
    //   if (this.rowData.length > 0) {
    //     this.selectedCourse = this.rowData[0].id;
    ...
    //     const selectedProduct = this.rowData.find(product => product.id === this.selectedCourse);
    //   if (selectedProduct) {
