                ...
                <div class="search_right_block">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-6 col-sm-6 col-md-6">
                            ...
                            <p id="duration_text" class="mb-2"><img src="../assets/images/Iconionic-ios-timer@2x.png"> 03h
                                32min</p>
                        </div>
                        <div class="col-lg-4 col-md-3  col-6 col-sm-6 col-md-6">
                            <p id="module_text" class="mb-2"><img src="../assets/images/Iconmap-school@2x.png"> 8 Modules
                            </p>
                        </div>
                    </div>
                </div>
