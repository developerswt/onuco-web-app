<template>
                 ...
                 <section id="tab_block">
                     <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
                         ...
                         <el-tab-pane label="LIVE" name="third">
                             ...
                             <div v-if="liveCompleted.length > 0" class="">
                                 <div v-if="selectedItem !== null" id="myTabContent" class="tab-content" >
                                     <div id="home" class="tab-pane fade show active" role="tabpanel" aria-labelledby="home-tab"  v-for="item in liveCompleted" :key="item.id" >
                                         <div class="row mt-4 ">
                                         ...
                                         <div class="inner_block">
                                            <router-link :to="{ name: 'CourseDetails', params: { name: item.courseRouteName } }" style="text-decoration: none;">
                                             <div class="row">
                                                 <div class="col-lg-1 col-4 col-sm-4 col-md-2">
                                                     <div id="asset_image">
                                                         <img src="../assets/images/book1.png" class="img-fluid">
                         ...
                         <el-tab-pane label="COMPLETED" name="fourth">
                             <div v-if="completedItems.length > 0" class="">
                                 <div v-if="selectedItem !== null" id="myTabContent" class="tab-content">
                                     <div id="home" class="tab-pane fade show active" role="tabpanel"
                                         ...
                                         <div class="">
                                             ...
                                             <div class="inner_block"  v-for="page in completedItems" :key="page.id">
                                                <router-link :to="{ name: 'CourseDetails', params: { name: page.courseRouteName } }" style="text-decoration: none;">
                                                 <div class="row">
                                                     <div class="col-lg-1 col-4 col-sm-4 col-md-2">
                                                         <div id="asset_image">
                                                             <img src="../assets/images/book1.png" class="img-fluid">
                                                     ...
                                                     <div class="col-lg-8 col-8 col-sm-8 col-md-8">
                                                         ...
                                                         <div class="row line">
                                                             <div class="col-lg-4 col-12 col-sm-12 col-md-4">
                                                                 <div class="progress_block">
                                                                     <div>
                                                                         <progress :value="calculatePercentage(page)" max="100">{{ getWatchTime(page) }}</progress>
                                                                 </div>
                                                             </div>
                                                         </div>
 ...
 export default {
     ...
     computed: {
         ...
         completedItems() {
        return this.myLearning.filter(item => item.videoCompleted);
    },
    liveCompleted() {
        return this.myLearning.filter(item => !item.videoCompleted);
    },
     ...
     methods: {
         ...
         getVideoOptions(videoUrl) {
         // Determine the type of video (MP4 or HLS) based on the URL
         let type = '';
     ...
     // Method to determine video type (MP4 or HLS) based on URL
