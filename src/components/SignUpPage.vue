...
export default {
    ...
    methods: {
            ...
            this.cognitoAuth.signup(
                ...
                (err, result) => {
                    ...
                    if (!this.picture) {
                        ...
                        this.errors.picture = 'File is required.';
                    }
                    if (!this.birthdate) {
                    ...
                    if (!this.phone_number) {
                        this.errors.phone_number = 'Mobile Number Is Required';
                    }
                    ...
                    if (!this.pass) {
                        this.errors.pass = "Please Enter Password ";
                    }
        ...
        required(e) {
            ...
            // //    this.isRequired = value ? false : true
            // let username = e.target.name;
            // this.Errormessage[username] = {
            //     state: value ? false : true,
            //     message: value ? "" : "This Field is Required",
            //     // state: !(/^[A-Za-z\s]+$/.test(value)),
            //     // message: /^[A-Za-z]+$/.test(value) ? "" : "Please Enter Correct UserName",
            // }
            if (this.username) {
